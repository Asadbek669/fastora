        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
            {results.map((item) => (
              ...
              >
                {/* CARD CONTAINER */}
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-800 hover:border-blue-500/40 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10">
                  {/* IMAGE CONTAINER */}
                  ...
                  {/* CONTENT */}
                  <div className="p-4">
                    <h3 className="font-bold text-base mb-2 line-clamp-1 group-hover:text-blue-300 transition-colors">
                      {item.title}
                    </h3>

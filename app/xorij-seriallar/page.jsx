...
export default async function Page() {
  ...
  const series = allSeries.filter((s) => s.category === "xorij-seriallar");

  return (
    <div className="p-4 pb-32">
      <h1 className="text-2xl font-semibold mb-4">Xorij seriallari</h1>

      {series.length === 0 && <p className="text-gray-400">Hozircha xorij seriallari mavjud emas.</p>}
